...
const Listeners = {
  ...
  async ListenerMarketPlaceSelltoken(status) {
    if (status) {
      marketPlaceSC.on(
        "SellToken",
  ...
  async ListenerMarketPlaceBuyToken(status) {
    if (status) {
      marketPlaceSC.on(
        "BuyToken",
        async (
  ...
  async ListenerMarketPlaceRemoveToken(status) {
    if (status) {
      marketPlaceSC.on(
        "RemoveToken",
  ...
  async ListenerSkillTransfer(status) {
    if (status) {
  ...
  async ListenerSkinTransfer(status) {
    if (status) {
  ...
  async ListenerERC1155MockUpTransferSingle(status) {
    if (status) {
      erc1155MockUp.on(
        "TransferSingle",
  ...
  async ListenerERC1155MockUpTransferBatch(status) {
    if (status) {
      erc1155MockUp.on(
        "TransferBatch",
            ...
            if (from !== "0x0000000000000000000000000000000000000000") {
              ...
              if (parseInt(amounts[i]._hex, 16) !== "0x00") {
                ...
                if (
                  ...
                  try {
                    console.log(
                      `Transferred erc1155MockUp token found in Sale!`
                    );
                    await marketPlaceSC
                      .connect(signer)
